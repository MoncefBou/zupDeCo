...
const headCells = [
    { id: 'name', numeric: false, disablePadding: true, label: '_id eleve' },
    { id: 'sex', numeric: true, disablePadding: false, label: 'Genre' },
    { id: 'calories', numeric: true, disablePadding: false, label: 'Classe' },
    { id: 'day', numeric: true, disablePadding: false, label: 'Jour' },
    { id: 'hour', numeric: true, disablePadding: false, label: 'heure' },
];

function EnhancedTableHead(props) {
    const { classes, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort, dataStudentAvailable } = props;
